          ...
          <div class="modal-body">
            ...
            <form v-if="mode === 'create'" class="po-form" @submit.prevent="submitForm">
              <div class="form-group">
                <label class="form-label" for="supplier">Supplier Name <span class="required">*</span></label>
                <input
                  id="supplier"
              ...
              <div class="form-row">
                <div class="form-group">
                  <label class="form-label" for="quantity">Quantity to Order <span class="required">*</span></label>
                  <input
                    id="quantity"
            ...
            <!-- View mode: existing PO details or no PO message -->
            <div v-else>
              <div v-if="backlogItem.purchase_order" class="po-details">
                <div class="info-grid">
                  <div class="info-item">
                    <div class="info-label">PO ID</div>
                    <div class="info-value po-id">{{ backlogItem.purchase_order_id }}</div>
                  </div>
                  ...
                  <div class="info-item">
                    ...
                    <div class="info-value total-value">{{ formatCurrency(backlogItem.purchase_order.total_cost) }}</div>
                  </div>
...
const formattedTotalCost = computed(() => {
  return formatCurrency(totalCost.value)
})
...
// Dummy method kept for @input compatibility (totalCost is computed, no manual trigger needed)
